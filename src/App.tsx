  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case ViewState.ADMIN: 
        if (userProfile?.id === 'OFFECAL' || authUser?.email === 'admin@flex.com' || userProfile?.adminRole === 'super_admin') { 
      ...
      case ViewState.PROFILE:
        ...
        // UPDATE: Allow super_admin by role to see the Owner Panel
        const isOwner = userProfile.id === 'OFFECAL' || authUser?.email === 'admin@flex.com' || userProfile.adminRole === 'super_admin';
          ...
          <div className="h-full bg-gray-900 text-white overflow-y-auto pb-24 relative font-sans">
            ...
            <div className="px-4 space-y-4">
                ...
                <div className="glass-card rounded-2xl overflow-hidden mb-6 bg-gray-800/50">
                    {/* Updated Check: isOwner now includes adminRole === 'super_admin' */}
